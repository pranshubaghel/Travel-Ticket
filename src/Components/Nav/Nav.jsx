    ...
    return (
        <>
            <div className="flex gap-2  bg-gray-800 p-4">
                <img className='h-[70px] w-[120px] ml-[50px] py-4' src="http://codexeco.com/hms/public/uploads/logo/d76e10d2292d1bfa9f000545009607c6_1640682030.png" />
                <div className="flex items-center space-x-4 px-10 w-[70%]">
